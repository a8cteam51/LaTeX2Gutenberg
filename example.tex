...
Erd\H{o}s's name cannot be properly typeset in HTML.
...
{\em do not nest a {\bf bold} text inside an emphasized
text or viceversa.}
...
\image{width = 300}{http://imgs.xkcd.com/comics/donald_knuth.png}{knuth.png}
